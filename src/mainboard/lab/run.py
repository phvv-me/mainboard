...
class Run:
    ...
    def artifact(
        ...
        """Write one named artifact under `artifact_dir` through `writer(path, payload)`.

        mainboard owns no serialization format; the caller's `writer` does.
        """
