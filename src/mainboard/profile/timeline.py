...
class DeviceGap(FrozenModel):
    ...
    def duration_ms(self) -> float:
        ...
        return (self.end_ns - self.start_ns) / _NANOSECONDS_PER_MS
...
class DeviceTimeline(FrozenModel):
    ...
    def from_traces(
        ...
        *,
        ...
        # Earliest start to latest end, not necessarily the last one sorted by start: a long
        # kernel can still be running when a shorter, later one finishes first.
        return cls(
