...
# `mainboard ci` is the only thing that runs it, from a developer's shell, from the pre-push hook,
# on a remote host of another platform, and from the GitHub workflow, which is reduced to
# checking out the code and calling that same verb.
#
