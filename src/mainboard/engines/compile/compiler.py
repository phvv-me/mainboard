...
from .pixi_manifest import PixiManifest, cleared
...
class Compiler:
    ...
    def _write_generated_files(self, files: Writer, *, compiled: str, env: str) -> None:
        ...
        if self.manifest.workspace.dotenv:
            files.write(self.out / _DOTENV_SH_FILE, _DOTENV_SH)
            files.write(self.out / _DOTENV_BAT_FILE, _DOTENV_CMD)
